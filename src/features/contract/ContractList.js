...
export function ContractList() {
    ...
    const fetchContracts = async (page, size) => {
        try {
            const data = await ContractService.fetchContracts(localStorage.getItem("token"),page, size);
                                ...
                                <table className="table table-striped table-hover">
                                    ...
                                    <tr>
                                        ...
                                        {AuthService.isAdmin() || AuthService.isManager() ? (
                                            <th>History Check</th>) : null}
                                        <th>Status</th>
                                        <th className="text-center">Actions</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    {contracts.length > 0 ? (contracts.map((c, index) => (<tr key={c.id}>
