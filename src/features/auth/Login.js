...
const validationSchema = Yup.object().shape({
    username: Yup.string()
        .required('Username is required'), password: Yup.string().required('Password is required')
});
let count = 3;
                            ...
                            <div className="card-body p-0">
                                <div className="row">
                                    ...
                                    <div className="col-lg-6" style={{background: "var(--bs-body-bg)"}}>
                                        ...
                                        <p className=" d-block  w-100 mb-3">Don't have account ? ->
                                            <Link to={"/register"}
                                                  style={{
                                                      color: "rgb(0,0,0)", borderColor: "var(--bs-btn-hover-color)"
                                                  }}>Register</Link>
                                        </p>
